...
//	<i>Default: 32
#define RT_THREAD_PRIORITY_MAX  32 //支持多少个优先级
// <o>OS tick per second
//  <i>Default: 1000   (1ms)
#define RT_TICK_PER_SECOND	1000   //每秒钟有多少个tick
...
#define RT_USING_COMPONENTS_INIT  //使用 RT-Thread组件初始化
// </c>
// <c1>Using user main
//  <i>Using user main
...
//	<i>Default: 512
#define RT_MAIN_THREAD_STACK_SIZE     512 //main 线程栈大小
